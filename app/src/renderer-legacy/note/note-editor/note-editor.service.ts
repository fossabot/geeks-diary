...
import { NoteCodeEditorSnippetCreateModalComponent } from './code-snippet-create-modal.component';
import { CodeLanguageService } from '../../code/code-language.service';
import { NoteEditorSnippet, NoteEditorSnippetEvent, NoteEditorSnippetEventName } from './note-editor-snippet';
import { NoteTextEditorSnippet } from './note-text-editor-snippet';
import { NoteCodeEditorSnippet } from './note-code-editor-snippet';
    ...
    createSnippetInstance(type: 'text' | 'code' = 'text'): NoteEditorSnippet {
        ...
        switch (type) {
            ...
            case 'code':
                ...
                return new NoteCodeEditorSnippet(snippetElem, this.codeLanguageService);
